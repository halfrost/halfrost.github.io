...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_1.png)
...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_2.png)
...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_3.png)
...
小结一下：
到此为止，上面提出的第二个问题就解开答案了。自动变量是以值传递方式传递到Block的构造函数里面去的。Block只捕获Block中会用到的变量。由于只捕获了自动变量的值，并内存地址，所以Block内部不能改变自动变量的值。Block捕获的外表变量可以改变值的是静态变量，静态全局变量，全局变量。上面例子也都证明过了。
...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_5.jpg)



OC中，一般Block就分为一下3种，\_NSConcreteStackBlock，\_NSConcreteMallocBlock，\_NSConcreteGlobalBlock。先来说明一下3者的区别。
...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_6.jpg)
...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_7.jpg)
...
![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_8.jpg)


带\_\_block的自动变量 和 静态变量 就是直接地址访问。所以在Block里面可以直接改变变量的值。

![](https://ob6mci30g.qnssl.com/Blog/ArticleImage/21_9.jpg)
